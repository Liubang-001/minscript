...
typedef enum {
    ...
    TOKEN_COLON, TOKEN_NEWLINE, TOKEN_AT,
    ...
    TOKEN_RETURN, TOKEN_TRUE, TOKEN_VAR,
    TOKEN_WHILE, TOKEN_BREAK, TOKEN_CONTINUE,
    TOKEN_IMPORT, TOKEN_AS, TOKEN_FROM, TOKEN_DEF,
    TOKEN_PASS, TOKEN_IN, TOKEN_NOT, TOKEN_IS,
    TOKEN_NONE, TOKEN_ELIF, TOKEN_WITH, TOKEN_LAMBDA,
